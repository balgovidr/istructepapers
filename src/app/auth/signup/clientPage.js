...
export default function SignUp() {
  ...
  return (
    <div className="row full-height">
      <Head>
          <title>Sign up - Structural Papers</title>
          <meta name="description" content="Sign up to access a repository of solved IStructE exam papers to guide your exam preparation."/>
          <link rel="canonical" href={process.env.NEXT_PUBLIC_HOST + '/auth/signup'} />
          <meta property="og:title" content="Sign up - Structural Papers" />
          <meta property="og:description" content="Sign up to access a repository of solved IStructE exam papers to guide your exam preparation." />
          <meta property="og:type" content="website" />
          <meta property="og:url" content={process.env.NEXT_PUBLIC_HOST + '/auth/signup'} />
