  ...
  return (
    <div className="row full-height">
        <Head>
            ...
            <meta name="description" content="Log in and access a repository of solved IStructE exam papers to guide your exam preparation."/>
            <link rel="canonical" href={process.env.NEXT_PUBLIC_HOST + '/auth/login'} />
            <meta property="og:title" content="Login - Structural Papers" />
            <meta property="og:description" content="Log in and access a repository of solved IStructE exam papers to guide your exam preparation." />
            <meta property="og:type" content="website" />
            <meta property="og:url" content={process.env.NEXT_PUBLIC_HOST + '/auth/login'} />
