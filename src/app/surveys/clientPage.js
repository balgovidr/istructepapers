    ...
    if (!user) {
        return (
            <div className="row full-height">
                <Head>
                    <title>Verify uploaded IStructE exam papers - Structural Papers</title>
                    <meta name="description" content="Check details of uploaded papers to verify their quality and earn points. Points can be used to view further IStructE exam papers to guide your exam preparation."/>
                    <link rel="canonical" href={process.env.NEXT_PUBLIC_HOST + '/surveys'} />
                    <meta property="og:title" content="Verify uploaded IStructE exam papers - Structural Papers" />
                    <meta property="og:description" content="Check details of uploaded papers to verify their quality and earn points. Points can be used to view further IStructE exam papers to guide your exam preparation." />
                    <meta property="og:type" content="website" />
                    <meta property="og:url" content={process.env.NEXT_PUBLIC_HOST + '/surveys'} />
                ...
                <div className="col-1 column pd-a-10p justify-content-center">
                    <h1>Verify uploaded IStructE exam papers</h1>
